...
#define STRING_CONFIG_H_AUTHOR "OPC" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_FARMER
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Farmer"
...
#define HOTEND_OFFSET_X {0.0, 374.8} // (in mm) for each extruder, offset of the hotend on the X axis
#define HOTEND_OFFSET_Y {0.0, -0.45}  // (in mm) for each extruder, offset of the hotend on the Y axis
#define HOTEND_OFFSET_Z {0.0, 0.3}
...
//    O-- FRONT --+
//  (0,0)
#define X_PROBE_OFFSET_FROM_EXTRUDER 12.55  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 18.4  // Y offset: -front +behind [the nozzle]
...
#define DEBUG_LEVELING_FEATURE
  ...
  //#define AUTO_BED_LEVELING_GRID
    ...
    #define ABL_PROBE_PT_1_X -19
    #define ABL_PROBE_PT_1_Y 318
    #define ABL_PROBE_PT_2_X -19
    #define ABL_PROBE_PT_2_Y 10
    #define ABL_PROBE_PT_3_X 325
...
//  #define Z_SAFE_HOMING_Y_POINT ((Y_MIN_POS + Y_MAX_POS) / 2)    // Y point for Z homing when homing all axis (G28).
  ...
  #define Z_SAFE_HOMING_Y_POINT 318    // Y point for Z homing when homing all axis (G28).
#endif
